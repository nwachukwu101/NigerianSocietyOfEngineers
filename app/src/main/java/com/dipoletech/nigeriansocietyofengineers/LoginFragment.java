...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        loginWithGButton = (com.google.android.gms.common.SignInButton)rootView.findViewById(R.id.sign_in_with_google);
        loginWithGButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //you shall grab the username and password text, validate it and then pass them to
                // the activity
